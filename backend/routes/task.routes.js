...
// GET /api/tasks/my — tasks assigned to the logged-in user
router.get('/my', async (req, res) => {
  try {
    const tasks = await Task.find({ assignedTo: req.user._id, isActive: true })
...
// GET /api/tasks/team — every active task org-wide, visible to managers/admins only
